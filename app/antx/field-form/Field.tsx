import toChildrenArray from '../rc-util/Children/toArray.ts';
...
import FieldContext, { HOOK_MARK } from './FieldContext.tsx';
...
class Field extends React.Component<InternalFieldProps, FieldState> implements FieldEntity {
  ...
  private prevValidating: boolean| undefined;
  ...
  public validateRules = (options?: ValidateOptions): Promise<RuleError[]> => {
    ...
    this.validatePromise = rootPromise as unknown as Promise<string[]> ;
    this.dirty = true;
    this.errors = EMPTY_ERRORS;
    this.warnings = EMPTY_ERRORS;
    this.triggerMetaEvent();
